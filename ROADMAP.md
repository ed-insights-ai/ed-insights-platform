...
19/85 tasks complete · **23 actionable now** · 42 blocked · 1 in progress · **19 days** to the season (2026-08-27)

## In progress

- `tl-hbo` **S0.5** · Fix fabricated home/away in both parsers (gh-20) ([#20](https://github.com/ed-insights-ai/ed-insights-platform/issues/20))
...
- [~] `tl-hbo` **P0** Fix fabricated home/away in both parsers (gh-20) ([#20](https://github.com/ed-insights-ai/ed-insights-platform/issues/20)) — *in progress*
...
- [ ] `tl-vf2` **P1** Unify the five inconsistent team matchers (gh-15, widened) ([#15](https://github.com/ed-insights-ai/ed-insights-platform/issues/15)) — *blocked by `tl-hbo`*
